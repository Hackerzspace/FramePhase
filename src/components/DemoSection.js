...
export default function DemoSection() {
  return (
    <section className="flex justify-around mt-8 sm:mt-12 items-center">
      <div data-aos="fade-left" className="hidden sm:block bg-gray-300/15 w-[240px] rounded-xl overflow-hidden">
      ...
      <div data-aos="fade-right" className="bg-gray-300/15 w-[240px] rounded-xl overflow-hidden">
